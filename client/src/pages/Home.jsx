    ...
    const fetchPosts = async () => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          setAllPosts(result.data.reverse()); // we are reversing it because we want to show the newest post at the top
        }
      } catch (error) {
        alert(error);
      } finally {
          ...
          <>
            {searchText && (
              <h2 className="font-medium text-[#666e75] text-xl mb-3">
                Showing Resuls for <span className="text-[#22232-]">{searchText}</span>:
              </h2>
            )}
